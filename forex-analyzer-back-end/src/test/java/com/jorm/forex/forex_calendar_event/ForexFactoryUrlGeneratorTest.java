...
public class ForexFactoryUrlGeneratorTest {
    ...
    public void shouldGenerateUrlForGivenDate(){
        assertEquals("https://www.forexfactory.com/calendar.php?day=aug23.2017", urlGenerator.generate(LocalDateTime.parse("23-08-2017 00:00:00", Format.dateTimeFormatter)));
        assertEquals("https://www.forexfactory.com/calendar.php?day=may9.2000", urlGenerator.generate(LocalDateTime.parse("09-05-2000 00:00:00", Format.dateTimeFormatter)));
